...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, setIsOpen }) => {
  ...
  const navigation = [
    ...
    { name: 'Customers', href: '/customers', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
    { name: 'Loans', href: '/loans', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  return (
    <>
      ...
      {/* Sidebar for mobile */}
      <div className={`fixed inset-y-0 left-0 z-40 w-64 transition duration-300 transform bg-white md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:static md:inset-0`}>
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-6 h-16 bg-white border-b border-gray-200">
            <div className="flex items-center">
              <Link to="/dashboard" className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-semibold text-gray-900">TrackFina</span>
              </Link>
            </div>
            <button 
          ...
          {/* Company Switcher - Keep this in sidebar */}
          {companies && companies.length > 0 && (
            <div className="px-6 py-4 border-b border-gray-200">
              <div className="flex flex-col space-y-1">
                <label className="block text-xs font-medium text-gray-500">Current Company</label>
                <select
          ...
          {/* Navigation */}
          <nav className="px-4 py-4 flex-grow overflow-y-auto">
