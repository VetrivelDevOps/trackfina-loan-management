...
const Dashboard = () => {
  ...
  return (
    <Layout>
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="relative">
          <select 
            ...
            className="appearance-none bg-white border border-gray-300 text-gray-700 py-2 px-4 pr-8 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500"
          >
      ...
      <div className="mb-6">
        <p className="text-gray-600">Welcome back, Vetrivel D</p>
      </div>
